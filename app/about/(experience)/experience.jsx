		...
		<section className="grid gap-8 md:gap-12">
			<div className="relative after:absolute after:inset-y-2 after:w-1 after:bg-gray-700 after:left-[-4px] md:after:left-1 lg:after:left-2 xl:after:left-3 grid gap-8 md:gap-12 pl-6 md:pl-8">
				<div className="grid gap-4 relative">
					...
					<div className="font-medium text-lg">2020 - Present</div>
					<div>
						<h3 className="font-semibold text-xl text-black">
							Learn HTML, CSS, and JavaScript
						</h3>
						<h4 className=" font-light text-md mb-4">
						Continuously developing web development skills with HTML, CSS, and JavaScript.
						</h4>
						<p className="text-justify">
						Created a personal project: a simple web API using Node.js to manage a to-do list. This project involved using Express.js for routing and implementing RESTful APIs.
						</p>
...
Specialized in crafting innovative solutions using Node.Js and Next.js, enhancing client satisfaction and project efficiency. Contributed expertise in both frontend and backend development during collaborative team projects, leading to successful project completions
						</p>
						<div className="flex flex-wrap gap-2 mt-4 text-sm">
							<div className="bg-gray-300 text-black px-2 py-1 rounded-2xl">
								React
